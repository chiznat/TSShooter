...
public class PlayerBehaviour : MonoBehaviour {
    ...
    // What the current speed of our player isprivate 
    ...
    void Rotation()
    {
        ...
        /*
          * Get the difference from each axis (stands for 
          * deltaX and deltaY)
        */
        ...
        /*
          * The transform's rotation property uses a Quanternion,
          * so we need to convret the angle in a Vector
    ...
    // Creates a laszer and gives it an inital postion in
    // front of the ship.
    void ShootLaser()
    {
        ...
        // Calculate the postion right in front of the ship's
